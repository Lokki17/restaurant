...
public class VoteRestControllerTest extends AbstractControllerTest {
    ...
    private static final String RESTAURANT_URL = VoteRestController.RESTAURANT_URL + "/";
    ...
    public void testGetAll() throws Exception {
        mockMvc.perform(get(RESTAURANT_URL + VOTE_URL)
    ...
    public void testGet() throws Exception {
        mockMvc.perform(get(RESTAURANT_URL + VOTE_URL + ADMIN_ID)
                .with(userHttpBasic(ADMIN)))
                .andExpect(status().isOk())
                .andDo(print())
                .andExpect(content().contentTypeCompatibleWith(MediaType.APPLICATION_JSON));
    ...
    public void testCreate() throws Exception {
        ...
        ResultActions action = mockMvc.perform(post(RESTAURANT_URL + (RESTAURANT_ID + 3) + VOTE_URL)
                .contentType(MediaType.APPLICATION_JSON)
                .content(JsonUtil.writeValue(created))
                .with(userHttpBasic(UserTestData.ADMIN_USER_FOR_TEST)));
...
/*    @Test
    ...
    public void testVoteUnauth() throws Exception {
        mockMvc.perform(post(VOTE_URL + VOICE_ID))
...
/*    @Test
    ...
    public void testUpdate() throws Exception {
        ...
        mockMvc.perform(put(RESTAURANT_URL + (RESTAURANT_ID + 1)+ VOTE_URL + VOICE_ID)
                .contentType(MediaType.APPLICATION_JSON)
