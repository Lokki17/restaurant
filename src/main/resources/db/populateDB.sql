...
INSERT INTO dishes (restaurant_id, date, name, price) VALUES
  (100003, '2016-12-12', 'Борщ', '15'),
  (100003, '2016-12-12', 'Суп', '15'),
  (100004, '2016-12-12', 'Котлеты', '15'),
  (100004, '2016-12-12', 'Шницель', '15'),
  (100005, '2016-12-12', 'Пицца', '15'),
  (100005, '2016-12-12', 'Сосиски', '15'),
  (100006, '2016-12-12', 'Просто еда', '15'),
  (100006, '2016-12-12', 'Колбаса', '15'),
  (100006, '2016-12-12', 'Вареники', '15');

INSERT INTO votes (restaurant_id, date, user_id) VALUES
  (100003, '2016-12-12', 100002),
  (100003, '2016-12-12', 100001),
  (100004, '2016-12-12', 100000);