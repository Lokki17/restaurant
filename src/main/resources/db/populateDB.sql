...
INSERT INTO dishes (restaurant_id, date, name, price) VALUES
  (100003, '2016-12-13', 'Борщ', '15'),
  (100003, '2016-12-13', 'Суп', '15'),
  (100004, '2016-12-13', 'Котлеты', '15'),
  (100004, '2016-12-13', 'Шницель', '15'),
  (100005, '2016-12-13', 'Пицца', '15'),
  (100005, '2016-12-13', 'Сосиски', '15'),
  (100006, '2016-12-13', 'Просто еда', '15'),
  (100006, '2016-12-13', 'Колбаса', '15'),
  (100006, '2016-12-13', 'Вареники', '15');

INSERT INTO votes (restaurant_id, date, user_id) VALUES
  (100003, '2016-12-13', 100002),
  (100003, '2016-12-13', 100001),
  (100004, '2016-12-13', 100000);