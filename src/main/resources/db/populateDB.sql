...
INSERT INTO dishes (restaurant_id, date, name, price) VALUES
  (100003, '2016-12-08', 'Борщ', '15'),
  (100003, '2016-12-08', 'Суп', '15'),
  (100004, '2016-12-08', 'Котлеты', '15'),
  (100004, '2016-12-08', 'Шницель', '15'),
  (100005, '2016-12-08', 'Пицца', '15'),
  (100005, '2016-12-08', 'Сосиски', '15'),
  (100006, '2016-12-08', 'Просто еда', '15'),
  (100006, '2016-12-08', 'Колбаса', '15'),
  (100006, '2016-12-08', 'Вареники', '15');

INSERT INTO voices (restaurant_id, date, user_id) VALUES
  (100003, '2016-12-08', 100002),
  (100003, '2016-12-08', 100001),
  (100004, '2016-12-08', 100000);