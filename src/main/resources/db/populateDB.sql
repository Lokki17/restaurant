...
INSERT INTO dishes (restaurant_id, date, name, price) VALUES
  (100003, '2016-12-11', 'Борщ', '15'),
  (100003, '2016-12-11', 'Суп', '15'),
  (100004, '2016-12-11', 'Котлеты', '15'),
  (100004, '2016-12-11', 'Шницель', '15'),
  (100005, '2016-12-11', 'Пицца', '15'),
  (100005, '2016-12-11', 'Сосиски', '15'),
  (100006, '2016-12-11', 'Просто еда', '15'),
  (100006, '2016-12-11', 'Колбаса', '15'),
  (100006, '2016-12-11', 'Вареники', '15');

INSERT INTO votes (restaurant_id, date, user_id) VALUES
  (100003, '2016-12-11', 100002),
  (100003, '2016-12-11', 100001),
  (100004, '2016-12-11', 100000);