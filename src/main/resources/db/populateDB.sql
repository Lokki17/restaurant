...
INSERT INTO dishes (restaurant_id, date, name, price) VALUES
  (100003, '2016-12-07', 'Борщ', '15'),
  (100003, '2016-12-07', 'Суп', '15'),
  (100004, '2016-12-07', 'Котлеты', '15'),
  (100004, '2016-12-07', 'Шницель', '15'),
  (100005, '2016-12-07', 'Пицца', '15'),
  (100005, '2016-12-07', 'Сосиски', '15'),
  (100006, '2016-12-07', 'Просто еда', '15'),
  (100006, '2016-12-07', 'Колбаса', '15'),
  (100006, '2016-12-07', 'Вареники', '15');

INSERT INTO voices (restaurant_id, date, user_id) VALUES
  (100003, '2016-12-07', 100002),
  (100003, '2016-12-07', 100001),
  (100004, '2016-12-07', 100000);