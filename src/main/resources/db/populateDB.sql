...
INSERT INTO dishes (restaurant_id, date, name, price) VALUES
  (100003, '2016-12-04', 'Борщ', '15'),
  (100003, '2016-12-04', 'Суп', '15'),
  (100004, '2016-12-04', 'Котлеты', '15'),
  (100004, '2016-12-04', 'Шницель', '15'),
  (100005, '2016-12-04', 'Пицца', '15'),
  (100005, '2016-12-04', 'Сосиски', '15'),
  (100006, '2016-12-04', 'Просто еда', '15'),
  (100006, '2016-12-04', 'Колбаса', '15'),
  (100006, '2016-12-04', 'Вареники', '15');

INSERT INTO voices (restaurant_id, date, user_id) VALUES
  (100003, '2016-12-04', 100002),
  (100003, '2016-12-04', 100001),
  (100004, '2016-12-04', 100000);