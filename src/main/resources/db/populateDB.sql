...
INSERT INTO dishes (restaurant_id, date, name, price) VALUES
  (100003, '2016-12-05', 'Борщ', '15'),
  (100003, '2016-12-05', 'Суп', '15'),
  (100004, '2016-12-05', 'Котлеты', '15'),
  (100004, '2016-12-05', 'Шницель', '15'),
  (100005, '2016-12-05', 'Пицца', '15'),
  (100005, '2016-12-05', 'Сосиски', '15'),
  (100006, '2016-12-05', 'Просто еда', '15'),
  (100006, '2016-12-05', 'Колбаса', '15'),
  (100006, '2016-12-05', 'Вареники', '15');

INSERT INTO voices (restaurant_id, date, user_id) VALUES
  (100003, '2016-12-05', 100002),
  (100003, '2016-12-05', 100001),
  (100004, '2016-12-05', 100000);