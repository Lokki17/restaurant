...
INSERT INTO dishes (restaurant_id, date, name, price) VALUES
  (100003, '2016-12-09', 'Борщ', '15'),
  (100003, '2016-12-09', 'Суп', '15'),
  (100004, '2016-12-09', 'Котлеты', '15'),
  (100004, '2016-12-09', 'Шницель', '15'),
  (100005, '2016-12-09', 'Пицца', '15'),
  (100005, '2016-12-09', 'Сосиски', '15'),
  (100006, '2016-12-09', 'Просто еда', '15'),
  (100006, '2016-12-09', 'Колбаса', '15'),
  (100006, '2016-12-09', 'Вареники', '15');

INSERT INTO voices (restaurant_id, date, user_id) VALUES
  (100003, '2016-12-09', 100002),
  (100003, '2016-12-09', 100001),
  (100004, '2016-12-09', 100000);